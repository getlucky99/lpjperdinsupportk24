...
async function apiCall(action, payload, retries) {
  ...
  // Kirim via GET dengan data di query string
  // URLSearchParams handle encoding dengan benar (single encode)
  // Apps Script doGet menerima via e.parameter.data (sudah auto-decode)
